...
public class UserFormController extends BaseFormController {
     ...
     *
     * @param roleManager the new role manager
     */
    @Autowired
    ...
    /* (non-Javadoc)
     * @see com.vn.smartdata.webapp.controller.BaseFormController#initBinder(javax.servlet.http.HttpServletRequest, org.springframework.web.bind.ServletRequestDataBinder)
     */
    @Override
    @InitBinder
            ...
            if (request.isUserInRole(Constants.ADMIN_ROLE)) {
                ...
                if (userRoles != null) {
                    ...
                    for (final String roleName : userRoles) {
                        user.addRole(roleManager.getRoleByName(roleName));
                    }
                }
            } else {
