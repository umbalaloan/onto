...
<head>
    <title><fmt:message key="session.timeout.title"/></title>
    <meta name="heading" content="<fmt:message key='session.timeout.title'/>"/>
</head>

<p>
    <fmt:message key="session.timeout.message">
