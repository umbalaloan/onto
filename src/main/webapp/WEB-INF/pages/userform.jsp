        ...
        <div>
            ...
            <div id="collapse-address" class="accordion-body collapse">
                <div class="form-group">
                    ...
                    <form:input cssClass="form-control" path="address" id="address"/>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-3 form-group">
                        ...
                        <form:input cssClass="form-control" path="postalCode" id="postalCode"/>
                    </div>
                </div>
                <div class="form-group">
                    <appfuse:label styleClass="control-label" key="user.address.country"/>
                    <appfuse:country name="address.country" prompt="" default="${user.country}"/>
                </div>
            </div>
        </div>
<c:choose>
