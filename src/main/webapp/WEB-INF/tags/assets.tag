...
<c:set var="assetsVersion" value="1.0" scope="application"/>
    ...
    <c:otherwise>
        <c:choose>
            <c:when test="${type == 'css'}">
				...
				<!-- style.css is included here for development purpose, the same goes for script.js -->
				<link rel="stylesheet" type="text/css" href="${base}/styles/style.css" />
				<link rel="stylesheet" type="text/css" href="${base}/styles/tables.css" />
				<link rel="stylesheet" type="text/css" href="${base}/styles/owl.css" />
            </c:when>
            <c:otherwise>
